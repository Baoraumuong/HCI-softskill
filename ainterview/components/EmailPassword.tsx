  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (mode === "signup") {
      ...
      if (error) {
        ...
        // Immediate redirect on successful password sign-in.
        // The onAuthStateChange listener above also fires, but redirecting
        // here as well ensures navigation happens even if the event fires
